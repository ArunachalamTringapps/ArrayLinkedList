...
let arr4 = ["arun", "bala", "ragul", "gopi", "mohan"];
...
let arr8 = ["arun", "bala", "ragul", "gopi", "mohan"];
arr8.fill("sai",0,3)
...
let arr11 = ["harish", "balajikumar", "ragul", "gopi", "mohan"];
...
let arr13 = ["king", "queen", "ragul", "gopi", "kumar"];
...
let arr17 = ["kumar", "lokith", "ragul", "gopi", "mohan"];
...
let arr19 = ["losses", "kumari", "ragul", "gopi", "mohan"];
arr19.pop();
console.log("19.pop ",arr19)


let arr20 = ["looses", "mental", "ragul", "gopi"];
arr20.push("mohan");
...
let arr24 = ["angel", "queen", "ragul", "gopi"];
arr24.shift()
